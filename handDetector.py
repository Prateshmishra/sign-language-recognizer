...
#     with open('load_model_error.txt', 'a') as f:
...
def pipe_cam(gui, vid_label):
    ...
    with mp_hands.Hands(
            ...
            frame_video_stream(names, curr_char, prev_char, word, sentence, vid_label,     hands,  th_entrybox, cc_entrybox, ow_entrybox, cw_entrybox, sent_entrybox)
            gui.root.mainloop()
